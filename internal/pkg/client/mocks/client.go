...
func (_mock *MockClient) UploadJobSummary(ctx context.Context, runID string, runtimeToken string, content string) error {
	ret := _mock.Called(ctx, runID, runtimeToken, content)

	if len(ret) == 0 {
		panic("no return value specified for UploadJobSummary")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string) error); ok {
		r0 = returnFunc(ctx, runID, runtimeToken, content)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
type MockClient_UploadJobSummary_Call struct {
	*mock.Call
}

// UploadJobSummary is a helper method to define mock.On call
//   - ctx context.Context
//   - runID string
//   - runtimeToken string
//   - content string
func (_e *MockClient_Expecter) UploadJobSummary(ctx any, runID any, runtimeToken any, content any) *MockClient_UploadJobSummary_Call {
	return &MockClient_UploadJobSummary_Call{Call: _e.mock.On("UploadJobSummary", ctx, runID, runtimeToken, content)}
}

func (_c *MockClient_UploadJobSummary_Call) Run(run func(ctx context.Context, runID string, runtimeToken string, content string)) *MockClient_UploadJobSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_UploadJobSummary_Call) Return(err error) *MockClient_UploadJobSummary_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockClient_UploadJobSummary_Call) RunAndReturn(run func(ctx context.Context, runID string, runtimeToken string, content string) error) *MockClient_UploadJobSummary_Call {
	_c.Call.Return(run)
	return _c
}
