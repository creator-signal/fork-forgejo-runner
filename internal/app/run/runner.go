...
func (r *Runner) Run(ctx context.Context, task *runnerv1.Task) error {
	...
	// Parse job logger level for the reporter
	var jobLoggerLevel *log.Level
	...
	reporter := report.NewReporter(ctx, cancel, r.client, task, r.cfg.Runner.ReportInterval, &r.cfg.Runner.ReportRetry, jobLoggerLevel)
	var runErr error
	defer func() {
