// This file is a copy of https://raw.githubusercontent.com/docker/cli/refs/tags/v29.5.2/cli/command/container/opts_test.go
// with adjusted imports and support for `--platform` patched in. It has to be updated from time to time.
//
...
func TestParseWithVolumes(t *testing.T) {
	...
	} else if _, exists := config.Volumes[arr[1]]; !exists { // ignore shadow-check
