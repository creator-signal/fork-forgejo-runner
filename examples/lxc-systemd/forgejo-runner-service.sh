...
DEFAULT_RUNNER_VERSION=12.10.2 # renovate: datasource=forgejo-releases depName=forgejo/runner
...
YQ_VERSION=v4.53.2 # renovate: datasource=github-releases depName=forgejo-runner-service-yq packageName=mikefarah/yq
SELF=${BASH_SOURCE[0]}
